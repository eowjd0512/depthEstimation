...
class decoder(nn.Module):
    ...
    def __init__(self,hidden_sizes, K):
        ...
        self.K = K
        self.Theta= Variable([2*K]).cuda() #TODO
        self.Y=Variable([W,H,2*K]).cuda() #TODO
        self.P=Variable([W,H,K]).cuda() #TODO
...
class ordinalLayer(nn.Module):
    ...
    def __init__(self,hidden_sizes, K):
        ...
        super(ordinalLayer, self).__init__()
